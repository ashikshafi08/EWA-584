	...
	public String  carouselfeature(Utilities utility, PrintWriter out){
		...
		for (OrderItem oi : utility.getCustomerOrders())
		{
			...
			{	
				...
				SmartDoorbell smartDoorbell = hm.get(oi.getName());
				...
				for(Map.Entry<String, String> acc:smartDoorbell.getAccessories().entrySet())
				{
					...
					SmartDoorbell smartDoorbell1= SaxParserDataStore.smartDoorBells.get(acc.getValue());
					if (k==0 )
					{
					...
					sb.append("<h3 style='margin-left: 150px;'>"+smartDoorbell1.getName()+"</h3>");
					sb.append("<strong>"+smartDoorbell1.getPrice()+"$</strong><ul>");
					sb.append("<li id='item'><img src='images/accessories/"+smartDoorbell1.getImage()+"' alt='' /></li>");
